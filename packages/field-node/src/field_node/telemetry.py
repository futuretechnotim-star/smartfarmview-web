        ...
        entities: list[tuple[str, str, dict[str, object]]] = [
            ...
            (
                ...
                "battery_runtime",
                {
                    ...
                    "state_topic": telemetry_topic,
                    "value_template": "{{ value_json.battery_runtime_hours | default('') }}",
            ...
            (
                ...
                "solar_net_avg_ma",
                {
                    ...
                    "state_topic": telemetry_topic,
                    "value_template": "{{ value_json.solar_net_avg_ma | default('') }}",
                    "unit_of_measurement": "mA",
            ...
            (
                ...
                "solar_projected_eod_soc",
                {
                    ...
                    "state_topic": telemetry_topic,
                    "value_template": "{{ value_json.solar_projected_eod_soc | default('') }}",
                    "unit_of_measurement": "%",
            ...
            (
                ...
                "solar_deficit_pct",
                {
                    ...
                    "state_topic": telemetry_topic,
                    "value_template": "{{ value_json.solar_deficit_pct | default('') }}",
                    "unit_of_measurement": "%",
